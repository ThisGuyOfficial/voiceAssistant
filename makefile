...
CLIB = -I /usr/include/python3.10 -I./lib/portaudio/include ./lib/portaudio/lib/.libs/libportaudio.a -I./lib/fftw-3.3.10/api -I./include/ \
	-lrt -lasound -ljack -pthread -lfftw3 -lpython3.10
